...
export function getHexagramStudy(hexagram: HexagramIdentity) {
  ...
  return {
    ...
    tuan: `彖传学习提示：从“${lower.nature}”与“${upper.nature}”的关系理解${shortName}，关注它为何在此时呈现为这样的通塞、进退与聚散。`,
    xiang: `象传学习提示：观察${upper.nature}在上、${lower.nature}在下的画面，把自然之象转成可复述的行为提醒：先辨位置，再定取舍。`,
