...
export default function LearnPage() {
  return (
    <main className="subpage">
      <header className="subpage-header"><Link href="/" className="back-link">← 回到今日</Link><p className="eyebrow">知识路径 · 由浅入深</p><h1>从阴阳爻线，走到卦象、干支与罗盘</h1><p className="subpage-lead">每一节都有核心说明、前置关系、易混点和相关工具。先理解再去测试学堂练习，不再在各页面塞入零散小题。</p></header>
